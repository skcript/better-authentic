...
var $_url = $.url(window.location),
    ...
    $__source_host_complete = $__source_protocol + "://" + $__host_url + ($__source_port ? ":" : "") + $__source_port + $__source_path,
    $current_page = $_url.attr("path").replace(/^\//g, ""),
    $current_page_full = $_url.attr("path"),
    ...
    $is_webmail = window.parent.location.search == "?webmail" ? 1 : 0;
...
function prt(a) {
    ...
    a.fn.replaceTagName = function(e) {
        var f = [],
            g = this.length;
        while (g--) {
...
function shortcut_control(a) {
    if (settings_hotkeys_active) {
        ...
        if (String.fromCharCode(a.which).toLowerCase() == settings_hotkey_toggle_key_usermin && window.parent.$('.switch-toggle input[id="open_usermin"]') && !window.parent.$('.switch-toggle input[id="open_usermin"]').is(":checked") && (product_name() != "Dash" && product_name() != "Virtualmin" && product_name() != "Cloudmin")) {
            a.preventDefault();
            window.parent.$('.switch-toggle input[id="open_usermin"]').trigger("click")
        }
        if (String.fromCharCode(a.which).toLowerCase() == settings_hotkey_toggle_key_webmail && window.parent.$('.switch-toggle input[id="open_webmail"]') && !window.parent.$('.switch-toggle input[id="open_webmail"]').is(":checked") && (product_name() != "Dash" && product_name() != "Virtualmin" && product_name() != "Cloudmin")) {
            a.preventDefault();
...
function set_switch_position(a) {
    ...
    if (a == "open_webmin" || a == "open_usermin") {
        window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/");
        ...
        if (a == "open_virtualmin") {
            window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?virtualmin");
            window.parent.$("#wrapper").data("virtual-server", 2);
            window.parent.$("#wrapper").data("server-manager", -1);
            window.parent.$("#wrapper").data("webmail", -1)
        } else {
            if (a == "open_cloudmin") {
                window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?cloudmin");
                window.parent.$("#wrapper").data("virtual-server", -1);
                window.parent.$("#wrapper").data("server-manager", 2);
                window.parent.$("#wrapper").data("webmail", -1)
            } else {
                if (a == "open_webmail") {
                    window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?webmail");
                    window.parent.$("#wrapper").data("virtual-server", -1);
                    window.parent.$("#wrapper").data("server-manager", -1);
...
function loading_left_start() {
    if (settings_loader_left) {
        $(".mCSB_container, .mCSB_dragger").css("top", "0");
        !window.parent.$("#_menu_loader").length && window.parent.$("body ul.navigation").before('<span id="_menu_loader"></span>');
        new Spinner($___spinner).spin(document.getElementById("_menu_loader"));
...
function initialize_navigation_select() {
    ...
    window.parent.$("aside select").on("select2:select", function(a) {
        window.parent.loading_left_start();
        window.parent.$("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=" + product_name(1).toLowerCase() + "&" + a.currentTarget.id + "=" + a.currentTarget.value + "", function() {
        ...
        if (product_name(1).toLowerCase() != "usermin") {
            setTimeout(function() {
                ...
                window.parent.$('iframe[name="page"]').attr("src", window.parent.$__source_host_complete + $____switch)
            }, 300)
        }
    });
...
function loading_left_end() {
    ...
    setTimeout(function() {
        window.parent.detect_current_left_menu("auto");
        if (window.location == window.parent.location && typeof window.parent.$('iframe[name="page"]').get(0).contentWindow.detect_current_left_menu == "function") {
            window.parent.$('iframe[name="page"]').get(0).contentWindow.detect_current_left_menu("auto")
        }
        open_target_parent();
        loader_start_config()
    }, 1212)
...
function autocomplete(b) {
    ...
    var g = {};
    $.each(window.parent.$('ul[id^="global_"].sub > li > a'), function(k, l) {
        g[($(this).attr("href").substring(0, 1) == "/" ? "" : "/") + $(this).attr("href")] = $.trim($(this).text())
    });
    window.parent.$('li > a[target="page"][data-href="/virtual-server/index.cgi"], li > a[target="page"][data-href="/sysinfo.cgi"], li > a[target="page"][data-href="/virtual-server/history.cgi"], li > a[target="page"][data-href="/mailbox/list_folders.cgi"], li > a[target="page"][data-href="/mailbox/list_ifolders.cgi"], li > a[target="page"][data-href="/mailbox/list_addresses.cgi"], li > a[target="page"][data-href="/filter/edit_forward.cgi"], li > a[target="page"][data-href="/filter/edit_auto.cgi"], li > a[target="page"][data-href="/filter/edit_auto.cgi"], li > a[target="page"][data-href="/filter/"], li > a[target="page"][data-href="/mailbox/edit_sig.cgi"]').each(function(k, l) {
        g[$(this).attr("data-href")] = $.trim($(this).text())
    });
    var c = $.map(g, function(l, k) {
        return {
            value: l,
            url: k,
            data: {
    ...
    var h = {};
    if ($current_page_full == "/custom/" || $current_page_full == "/custom/index.cgi" || $current_page_full == "/backup-config/" || $current_page_full == "/backup-config/index.cgi" || $current_page_full == "/usermin/" || $current_page_full == "/usermin/index.cgi" || $current_page_full == "/webmin/" || $current_page_full == "/webmin/index.cgi" || $current_page_full == "/acl/" || $current_page_full == "/acl/index.cgi" || $current_page_full == "/init/" || $current_page_full == "/init/index.cgi" || $current_page_full == "/mount/" || $current_page_full == "/mount/index.cgi" || $current_page_full == "/quota/" || $current_page_full == "/quota/index.cgi" || $current_page_full == "/fsdump/" || $current_page_full == "/fsdump/index.cgi" || $current_page_full == "/inittab/" || $current_page_full == "/inittab/index.cgi" || $current_page_full == "/logrotate/" || $current_page_full == "/logrotate/index.cgi" || $current_page_full == "/mailcap/" || $current_page_full == "/mailcap/index.cgi" || $current_page_full == "/pam/" || $current_page_full == "/pam/index.cgi" || $current_page_full == "/proc/" || $current_page_full == "/proc/index_tree.cgi" || $current_page_full == "/proc/index_user.cgi" || $current_page_full == "/proc/index_size.cgi" || $current_page_full == "/proc/index_cpu.cgi" || $current_page_full == "/proc/index_tree.cgi" || $current_page_full == "/proc/index_search.cgi" || $current_page_full == "/cron/" || $current_page_full == "/cron/index.cgi" || $current_page_full == "/syslog/" || $current_page_full == "/syslog/index.cgi" || $current_page_full == "/useradmin/" || $current_page_full == "/useradmin/index.cgi" || $current_page_full == "/apache/" || $current_page_full == "/apache/index.cgi" || $current_page_full == "/bind8/" || $current_page_full == "/bind8/index.cgi" || $current_page_full == "/dhcpd/" || $current_page_full == "/dhcpd/index.cgi" || $current_page_full == "/dovecot/" || $current_page_full == "/dovecot/index.cgi" || $current_page_full == "/ldap-server/" || $current_page_full == "/ldap-server/index.cgi" || $current_page_full == "/virtualmin-nginx/" || $current_page_full == "/virtualmin-nginx/index.cgi" || $current_page_full == "/fetchmail/" || $current_page_full == "/fetchmail/index.cgi" || $current_page_full == "/mysql/" || $current_page_full == "/mysql/index.cgi" || $current_page_full == "/mysql/edit_dbase.cgi" || $current_page_full == "/postgresql/" || $current_page_full == "/postgresql/index.cgi" || $current_page_full == "/postgresql/edit_dbase.cgi" || $current_page_full == "/postfix/" || $current_page_full == "/postfix/index.cgi" || $current_page_full == "/procmail/" || $current_page_full == "/procmail/index.cgi" || $current_page_full == "/proftpd/" || $current_page_full == "/proftpd/index.cgi" || $current_page_full == "/mailboxes/" || $current_page_full == "/mailboxes/index.cgi" || $current_page_full == "/mailboxes/list_mail.cgi" || $current_page_full == "/samba/" || $current_page_full == "/samba/index.cgi" || $current_page_full == "/spam/" || $current_page_full == "/spam/index.cgi" || $current_page_full == "/squid/" || $current_page_full == "/squid/index.cgi" || $current_page_full == "/sshd/" || $current_page_full == "/sshd/index.cgi" || $current_page_full == "/webalizer/" || $current_page_full == "/webalizer/index.cgi" || $current_page_full == "/cpan/" || $current_page_full == "/cpan/index.cgi" || $current_page_full == "/htaccess-htpasswd/" || $current_page_full == "/htaccess-htpasswd/index.cgi" || $current_page_full == "/status/" || $current_page_full == "/status/index.cgi" || $current_page_full == "/net/" || $current_page_full == "/net/index.cgi" || $current_page_full == "/tcpwrappers/" || $current_page_full == "/tcpwrappers/index.cgi" || $current_page_full == "/fdisk/" || $current_page_full == "/fdisk/index.cgi" || $current_page_full == "/fail2ban/" || $current_page_full == "/fail2ban/index.cgi" || $current_page_full == "/nis/" || $current_page_full == "/nis/index.cgi" || $current_page_full == "/passwd/" || $current_page_full == "/passwd/index.cgi") {
        $(window.parent.$('iframe[name="page"]').contents().find(".panel-body a[href]:not([href*='javascript'],[href*='list_users.cgi?dom'],[href*='edit_hdparm.cgi?disk'],[href*='blink.cgi?disk'],[href*='smart-status/index.cgi?drive'],[href*='help.cgi'],[href*='edit_user.cgi?new='],[href*='edit_user.cgi?idx='],[href*='edit_recipe.cgi'],[href*='up.cgi'],[href*='down.cgi'],[href*='virt_index.cgi'],[href*='save_log.cgi'],[href*='backup.cgi'],[href*='activate.cgi'],[href*='#'])")).each(function(k, l) {
            if ($current_page_full == "/syslog/" || $current_page_full == "/syslog/index.cgi") {
                h["/" + $current_page + $(this).parent("td").next("td.td_tag").next("td.td_tag").next("td.td_tag").find("a").attr("href")] = $.trim($(this).text())
            } else {
                if ($current_page_full == "/backup-config/" || $current_page_full == "/backup-config/index.cgi") {
                    $description = $.trim($(this).parent("td").next("td.td_tag").next("td.td_tag").text())
                } else {
                    if ($current_page_full == "/mount/" || $current_page_full == "/mount/index.cgi" || $current_page_full == "/quota/" || $current_page_full == "/quota/index.cgi") {
                        $description = $.trim($(this).parent("td").next("td.td_tag").next("td.td_tag").text())
                    } else {
                        if ($current_page_full == "/fsdump/" || $current_page_full == "/fsdump/index.cgi") {
                            $description = $.trim($(this).parents("td").next("td").next("td").next("td").find("label").find("tt").find("tt").text())
                        } else {
                            if ($current_page_full == "/proc/" || $current_page_full == "/proc/index_tree.cgi" || $current_page_full == "/proc/index_user.cgi" || $current_page_full == "/proc/index_size.cgi" || $current_page_full == "/proc/index_cpu.cgi" || $current_page_full == "/proc/index_tree.cgi" || $current_page_full == "/proc/index_search.cgi") {
                                if ($current_page_full == "/proc/index_size.cgi" || $current_page_full == "/proc/index_cpu.cgi") {
                                    ...
                                    if ($current_page_full == "/proc/index_search.cgi") {
                                ...
                                if ($current_page_full == "/useradmin/" || $current_page_full == "/useradmin/index.cgi") {
                                    ...
                                    if ($current_page_full == "/mailboxes/list_mail.cgi") {
                                        ...
                                        if ($current_page_full == "/cpan/" || $current_page_full == "/cpan/index.cgi") {
                                            $description = $.trim($(this).parents("td").next("td").next("td").find("label").text())
                                        } else {
                                            if ($current_page_full == "/fdisk/" || $current_page_full == "/fdisk/index.cgi") {
                ...
                h[($(this).attr("href").substring(0, 1) == "/" ? "" : "/") + $current_page + $(this).attr("href")] = $.trim($(this).text()) + ($_description ? " (" : "") + $description + ($_description ? ")" : "")
            }
        })
    }
    var i = $.map(h, function(l, k) {
        return {
            value: l,
            url: k,
            data: {
    ...
    var j = {};
    $.each(window.parent.$('ul.sub:not([id^="global_"]) > li > a'), function(k, l) {
        j[($(this).attr("href").substring(0, 1) == "/" ? "" : "/") + $(this).attr("href")] = $.trim($(this).text())
    });
    window.parent.$('li > a[target="page"]:not([data-href="/acl/edit_user.cgi"],[data-href="/virtual-server/index.cgi"],[data-href="/sysinfo.cgi"],[data-href="/virtual-server/history.cgi"], [data-href="/mailbox/list_folders.cgi"], [data-href="/mailbox/list_ifolders.cgi"], [data-href="/mailbox/list_addresses.cgi"], [data-href="/filter/edit_forward.cgi"], [data-href="/filter/edit_auto.cgi"], [data-href="/filter/edit_auto.cgi"], [data-href="/filter/"], [data-href="/mailbox/edit_sig.cgi"])').each(function(k, l) {
        if (product_name(1).toLowerCase() != "usermin") {
            j[$(this).attr("data-href")] = $.trim($(this).text())
        }
    });
    var a = $.map(j, function(l, k) {
        return {
            value: l,
            url: k,
            data: {
    ...
    if (window.parent.location.search) {
        var e = a.concat(i).concat(f).concat(c)
    } else {
        var e = f.concat(i).concat(a).concat(c)
    }
    window.parent.$(".form-control.sidebar-search").on("keydown", function(k) {
        if (k.keyCode == 39 || k.keyCode == 37 || k.keyCode == 36 || k.keyCode == 35 || k.keyCode == 34 || k.keyCode == 33 || k.keyCode == 20 || k.keyCode == 17 || k.keyCode == 16 || k.keyCode == 9 || k.shiftKey || k.ctrlKey) {
            k.preventDefault();
            k.stopPropagation()
        }
    });
    window.parent.$(".form-control.sidebar-search").autocomplete({
        ...
        onSelect: function(k) {
            $(this).val("").blur();
            hide_mobile_menu();
            if (k.url.substring(0, 1) == "/") {
                if (k.url && k.url.indexOf("virtual-server/link.cgi") === -1) {
                    window.parent.__lrs()
                }
                var l = window.parent.$("body").find('a[href="' + k.url + '"]').attr("target");
                if (l && l == "_parent") {
                    window.parent.location.href = window.parent.$("body").find('a[href="' + k.url + '"]').attr("href")
                } else {
                    window.parent.$('iframe[name="page"]').attr("src", ((k.url && k.url.indexOf("servers/link.cgi") > -1) ? k.url : window.parent.$__source_host_complete + $webprefix + k.url))
                }
            } else {
                window.parent.__lrs();
                window.parent.loading_left_start();
                window.parent.$("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=" + product_name(1).toLowerCase() + "&" + k.url.split(":::")[1] + "=" + k.url.split(":::")[0] + "", function() {
                    window.parent.loading_left_end();
                    if (product_name(1).toLowerCase() != "usermin") {
                        setTimeout(function() {
                            if (product_name(1).toLowerCase() == "cloudmin") {
                                ...
                                $____switch = "/virtual-server/summary_domain.cgi?" + k.url.split(":::")[1] + "=" + k.url.split(":::")[0]
                            }
                            window.parent.$('iframe[name="page"]').attr("src", window.parent.$__source_host_complete + $____switch)
                        }, 300)
                    }
...
function loader_start_config() {
    ...
    if ($current_page == "servers/") {
        $.each($('a[href^="link.cgi"].ui_link'), function() {
    ...
    if (window.location != window.parent.location) {
        $("body").on("click", 'a[href*="javascript:history.back()"]', function(a) {
            a.preventDefault();
            a.stopPropagation();
            setTimeout(function() {
                window.parent.__lrs()
    ...
    $("body").on("click", '.user-links > li > a, .dropdown > ul > li > a[data-loader="true"], .navigation a[target="page"], a[href$="virtual-server/index.cgi"], table.table-hover a:not([target="_blank"]), .list-group-item, .menu-link, .panel-body > a.ui_link, button[type="submit"], a.btn.btn-primary[href^="/"], a.ui_link, div.icons-row div a, td[id^="head"] a, tr.tr_tag td.td_tag a, tr.ui_checked_columns td a, tr.ui_grid_row td.ui_grid_cell a, a[href*=".cgi"], a[href$=".cgi"], input[type="submit"], .navigation_module_trigger', function() {
        var f = $(this),
            c = $.trim($(this).text()).toLowerCase(),
            h = $(this).attr("name"),
            d = ["/virtualmin-awstats/", "/tunnel/", "/updown/", "/webmin/edit_themes.cgi", "/usermin/edit_themes.cgi", "/webmin/edit_mods.cgi", "/usermin/edit_mods.cgi"],
            a = $current_page_full,
            g = ["export", "export as csv.", "download", "upload"],
            b = ["switch"],
            e = ["detachall.cgi"];
        $forbidden_onclicks = ["print_mail.cgi"];
        typeof f.attr("href") == "undefined" ? $forbidden_href = "" : $forbidden_href = f.attr("href");
        typeof f.attr("onclick") == "undefined" ? $forbidden_onclick = "" : $forbidden_onclick = f.attr("onclick");
        typeof f.attr("href") == "undefined" ? f.attr("href", "") : false;
        if (a && a.indexOf("/virtualmin-awstats/") === -1 && $forbidden_onclick.indexOf($forbidden_onclicks) === -1 && $forbidden_href.indexOf(e) === -1 && $.inArray(a, d) === -1 && $.inArray(c, g) === -1 && $.inArray(h, b) === -1 || ($.inArray(a, d) !== -1 && ($(this).attr("href") == "/" + $current_page.split("/")[0] + "/" || $(this).attr("href") == "/" + $current_page.split("/")[0] + "/index.cgi"))) {
            if (f.attr("target") != "_blank" && !f.hasClass("select_all") && !f.hasClass("select_invert") && $(this).attr("type") != "checkbox" && $(this).find("input").length <= 0 && $(this).attr("href").indexOf("history_data.cgi") === -1 && $(this).attr("href").indexOf("detach.cgi") === -1 && $(this).attr("href").indexOf("&raw=1") === -1 && $(this).attr("href").indexOf("showpass.cgi") === -1 && $(this).attr("href").indexOf("/virtual-server/link.cgi") === -1 && $(this).attr("href").indexOf("/virtualmin-awstats/view.cgi") === -1) {
                if ($(this).attr("onclick") && $(this).attr("onclick").indexOf("window.open") === 0) {} else {
                    window.parent.__lrs()
                }
            }
        }
...
loader_start_config();
window.parent.$(window).on("keydown", dblrclick(function(a) {
    if (a.shiftKey) {
        window.parent.__lre()
    }
}));

function detect_current_left_menu(c) {
    if (c != "auto") {
        $current_page = c
    } else {
        $current_page = $_url.attr("path").replace(/^\//g, "")
    ...
    $current_page_search = window.parent.$('iframe[name="page"]').get(0).contentWindow.location.search;
    var b = [];
    window.parent.$("ul.sub li a").each(function() {
        if ($(this).attr("href").substring(0, 1) == "/") {
            b.push($(this).attr("href").substring(1))
        } else {
            b.push($(this).attr("href"))
        }
    });
    if (($current_page_full && $current_page_full.indexOf("/servers/link.cgi/") === -1) && (b.indexOf($current_page) > -1 || b.indexOf(($current_page + "index.cgi")) > -1 || b.indexOf($current_page + $current_page_search) > -1 || b.indexOf(($current_page_full)) > -1 || b.indexOf(($current_page_full.substring(1))) > -1)) {
        clear_menu_select();
        if (window.parent.$('a[href="' + $current_page + 'index.cgi"]').length) {
            ...
            window.parent.$('a[href="' + $current_page + '"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
        } else {
            if (window.parent.$('a[href="' + $current_page_full + '"]').length) {
                window.parent.$('a[href="' + $current_page_full + '"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
            } else {
                if (window.parent.$('a[href="' + $current_page_full.substring(1) + '"]').length) {
                    window.parent.$('a[href="' + $current_page_full.substring(1) + '"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
                }
            }
        }
    } else {
        if ($is_virtualmin || $is_cloudmin) {
            ...
            if ($current_page_with_path == "virtual-server/webminlog") {
                ...
                if ($current_page_with_path == "virtual-server/syslog") {
                    ...
                    if ($current_page_with_path == "virtual-server/apache") {
                        ...
                        if ($current_page_with_path == "virtual-server/webalizer") {
                            ...
                            if ($current_page_with_path == "virtual-server/virtualmin-git") {
                                $current_page_with_path = "virtualmin-git/index.cgi?"
                            } else {
                ...
                clear_menu_select();
                window.parent.$('a[href^="/' + $current_page_with_path + "?" + $_url.attr("query") + '"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
            } else {
                if ($current_page_with_path == "syslog/save_log.cgi") {
                    if ($_url.attr("query").indexOf("access_log") > -1) {
                        clear_menu_select();
                        window.parent.$('a[href$="access%5Flog"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
                    } else {
                        if ($_url.attr("query").indexOf("error_log") > -1) {
                            clear_menu_select();
                            window.parent.$('a[href$="error%5Flog"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
                        }
                    }
                } else {
                    if ($current_page_with_path == "webalizer/edit_log.cgi") {
                        clear_menu_select();
                        window.parent.$('a[href$="access%5Flog&type=1"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
                    } else {
                        if ($current_page_with_path == "config.cgi" || $current_page_with_path == "/config.cgi") {
                            clear_menu_select();
                            if (window.parent.$('a[href^="/config.cgi"]').length) {
                                window.parent.$('a[href^="/config.cgi"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
                            } else {
                                if (window.parent.$('a[href^="config.cgi"]').length) {
                                    window.parent.$('a[href^="config.cgi"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
                                }
                            ...
                            if ($current_page_with_path == "webminlog/search.cgi?") {
                                clear_menu_select();
                                window.parent.$('a[href^="/webminlog/search.cgi"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
                            } else {
                                if ($current_page_with_path == "virtualmin-git/index.cgi") {
                                    clear_menu_select();
                                    window.parent.$('a[href^="/virtualmin-git/index.cgi?"]').parent("li").addClass("sub_active").append('<span class="current"></span>').parent("ul.sub").show().prev("li").addClass("active")
                                }
                            }
                        }
                    }
    ...
    window.parent.$("a.navigation_module_trigger").each(function() {
        if ($(this).hasClass("navigation_trigger_single_link")) {
            a.push($(this).data("href"))
        } else {
            if ($(this).data("href") != "/virtual-server/index.cgi") {
                a.push($(this).data("href"))
            } else {
                if ($(this).data("href") == "/virtual-server/index.cgi") {
                    a.push("/virtual-server");
                    a.push("/virtual-server/index.cgi")
                }
            }
        }
    });
    $_current_page_search = "/" + $current_page.replace(/\/$/, "") + $current_page_search;
    if ($current_page_full == "/virtual-server/history.cgi") {
        clear_menu_select();
        window.parent.$('a[data-href="/virtual-server/history.cgi"]').parent("li").addClass("sub_active").append('<span class="current-large"></span>')
    } else {
        if ($current_page_full == "/server-manager/index.cgi") {
            clear_menu_select();
            window.parent.$('a[data-href="/server-manager/index.cgi"]').parent("li").addClass("sub_active").append('<span class="current-large"></span>')
        } else {
            if ($current_page_full == "/webmin_search.cgi") {
                clear_menu_select()
            } else {
                if ((a.indexOf($_current_page_search) > -1)) {
                    clear_menu_select();
                    window.parent.$('a[data-href="' + $_current_page_search + ($_current_page_search == "/virtual-server" ? "/index.cgi" : "") + '"]').parent("li").addClass("sub_active").append('<span class="current-large"></span>')
                } else {
                    if (window.parent.$("#wrapper").data("product") == "usermin" && $is_webmail && $current_page_full && ($current_page_full.indexOf("/mailbox") || $current_page_full.indexOf("/filter"))) {
                        ...
                        $.each(a, function(d, e) {
                            if ($_current_page_search_no_extra && $_current_page_search_no_extra.indexOf(e) > -1) {
                                if (window.parent.$('a[data-href="' + e + '"]').length > 0) {
                                    clear_menu_select();
                                    window.parent.$('a[data-href="' + e + '"]').find(".fa.fa-folder-o").addClass("fa-folder-open-o");
                                    window.parent.$('a[data-href="' + e + '"]').parent("li").addClass("sub_active").append('<span class="current-large"></span>')
                                }
                            }
                        });
                        ...
                        if (window.parent.$('a[data-href="' + $__relative_url + '"]').length > 0) {
                            ...
                            window.parent.$('a[data-href="' + $__relative_url + '"]').parent("li").addClass("sub_active").append('<span class="current-large"></span>')
                        }
                        if ($current_page_full == "/mailbox/") {
                            if (window.parent.$('a[data-href="' + $_current_page_search + '"]').length > 0) {
                                ...
                                window.parent.$('a[data-href="' + $_current_page_search + '"]').parent("li").addClass("sub_active").append('<span class="current-large"></span>')
                            } else {
                                if (window.parent.$('a[data-href="/mailbox/index.cgi?id=INBOX"]').length > 0 && a.indexOf("/" + $current_page) === -1) {
                                    clear_menu_select();
...
if (window.location == window.parent.location) {
    ...
    $("body").on("click", ".navigation > li:not('.menu-container'):not('.navigation_external')", function(d) {
        d.preventDefault();
        d.stopPropagation();
            ...
            $.when($("#sidebar .navigation > li").each(function() {
                ...
                if (!$(this).is(b)) {
                    ...
                    if ($(this).find("a").attr("href") != "#search" && !$(this).find("a").attr("target")) {
                        if ($(e.find("a").attr("href")).hasClass("sub")) {
                            $(e.find("a").attr("href")).slideUp(280)
                        }
                    }
                }
            })).done(function() {
    ...
    $("body").on("click", ".navigation > ul.sub > li:not('.menu-container')", function() {
        var a = $(this);
        if (__num()) {
            window.parent.$(".navigation > li:not('.has-sub')").removeClass("sub_active").find("span.current-large").remove()
        }
    ...
    $("aside .form-group .form-control.sidebar-search").on("focus", function(a) {
        $(this).prev("i.fa.fa-search").css("color", "#5f84ae")
    }).on("blur", function(a) {
        $(this).prev("i.fa.fa-search").css("color", "#416083")
    });
    ...
    $("body").on("click", ".navigation_module_trigger", function(a) {
        ...
        window.parent.$(".navigation > ul.sub > li").removeClass("sub_active").find("span.current").remove();
        window.parent.$("#sidebar .navigation > ul.sub").slideUp(340);
    ...
    $("body").on("click", 'a[data-refresh="true"]', function(a) {
        a.preventDefault();
        __lrs();
        window.parent.$('iframe[name="page"]').get(0).contentWindow.location.reload()
    });
    ...
    $(".switch-toggle").on("click", 'input:not(".dynamic")', function(a) {
        if ($(this).attr("id") == "open_webmin" || $(this).attr("id") == "open_usermin") {
            ...
            window.location.href = window.parent.$__source_host_complete + "/"
        } else {
            if ($(this).attr("id") == "open_virtualmin") {
                window.parent.set_switch_position("open_virtualmin");
                window.location.href = window.parent.$__source_host_complete + "/?virtualmin"
            } else {
                if ($(this).attr("id") == "open_cloudmin") {
                    window.parent.set_switch_position("open_cloudmin");
                    window.location.href = window.parent.$__source_host_complete + "/?cloudmin"
                } else {
                    if ($(this).attr("id") == "open_webmail") {
                        window.parent.set_switch_position("open_webmail");
                        window.location.href = window.parent.$__source_host_complete + "/?webmail"
                    }
                }
            }
        }
    ...
    window.parent.$(".switch-toggle").on("click", "input.dynamic", function(c) {
        ...
        setTimeout(function() {
            var d = a;
            if (settings_right_reload == true) {
                __lrs()
            }
            loading_left_start();
            if (b.attr("id") == "open_webmin" || b.attr("id") == "open_usermin" || b.attr("id") == "open_webmail") {
                window.parent.set_switch_position(b.attr("id"));
                b.attr("id") == "open_webmail" ? $open_type = "webmail" : $open_type = "webmin";
                $("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=" + $open_type, function() {
                    window.parent.loading_left_end()
                });
                if (settings_right_reload == true) {
                    $("body").append('<span id="____switch"></span>');
                    $("#____switch").load("index.cgi/?xhr-switch=1", function() {
                        $____switch = $("#____switch").text();
                        window.parent.$('iframe[name="page"]').attr("src", window.parent.$__source_host_complete + (($____switch.substring(0, 1) == "/" ? "" : "/") + $____switch));
                        $("#____switch").remove()
                    })
                }
            } else {
                if (b.attr("id") == "open_virtualmin") {
                    window.parent.set_switch_position("open_virtualmin");
                    $("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=virtualmin", function() {
                        window.parent.loading_left_end()
                    });
                    if (settings_right_reload == true) {
                        window.parent.$('iframe[name="page"]').attr("src", window.parent.$__source_host_complete + "/" + settings_right_virtualmin_default)
                    }
                } else {
                    if (b.attr("id") == "open_cloudmin") {
                        window.parent.set_switch_position("open_cloudmin");
                        $("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=cloudmin", function() {
                            window.parent.loading_left_end()
                        });
                        if (settings_right_reload == true) {
                            window.parent.$('iframe[name="page"]').attr("src", window.parent.$__source_host_complete + "/" + settings_right_cloudmin_default)
                        }
                    }
                }
            ...
            $("body ul.user-links").load("index.cgi/?xhr-buttons=1&xhr-buttons-type=" + $is_virtualcloudmin + "");
    ...
    $("body").on("dblclick", ".loader-container", function(a) {
        __lre()
    });
    ...
    $("select").each(function() {
        if ($(this).attr("onchange") && $(this).attr("onchange").indexOf("form.submit") > -1 && settings_loader_right) {
            $(this).attr("onchange", $(this).attr("onchange") + ";window.parent.$('iframe[name=\"page\"]').css('display', 'none');window.parent.$('a[data-refresh=\"true\"]').find('i');window.parent.$('.loader-container').css('display', 'block');")
        }
    });
    ...
    if ($current_page_full == "/webmin/refresh_modules.cgi" || ($current_page_full == "/virtual-server/import.cgi" && $(".panel-body").html() && $(".panel-body").html().indexOf('name="confirm"') === -1) || ($current_page_full == "/server-manager/add.cgi" && $(".panel-body").html() && $(".panel-body").html().indexOf("javascript:history.back") === -1) || ($current_page_full == "/server-manager/mass.cgi" && $(".panel-body").html() && $(".panel-body").html() && $(".panel-body").html().indexOf('action="mass.cgi"') === -1 && $(".panel-body").html().indexOf("<font") === -1) || ($current_page_full == "/acl/index.cgi" && $.url($__source_url).attr("query") == "refresh=1") || ($.url($__source_url).attr("directory") == "/virtual-server/" && $.url($__source_url).param("confirm") && $.url($__source_url).param("confirm").toLowerCase().indexOf("yes") > -1)) {
        window.parent.loading_left_start();
        window.parent.$("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=" + product_name(1).toLowerCase(), function() {
            window.parent.loading_left_end();
            detect_current_left_menu("auto")
        })
    }
    if ($.url($__source_url).attr("query") && $.url($__source_url).attr("query").indexOf("refresh=1") > -1 && window.parent.$("aside select").val()) {
        ...
        window.parent.loading_left_start();
        window.parent.$("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=" + product_name(1).toLowerCase() + "&" + $domsid + "=" + window.parent.$("aside select").val(), function() {
            window.parent.loading_left_end();
            detect_current_left_menu("auto")
        })
    }
    if ($current_page_full == "/virtual-server/view_domain.cgi" || $current_page_full == "/virtual-server/list_aliases.cgi" || $current_page_full == "/virtual-server/list_users.cgi" || $current_page_full == "/virtual-server/move.cgi" || $current_page_full == "/virtual-server/clone.cgi" || $current_page_full == "/virtual-server/rename.cgi" || $current_page_full == "/virtual-server/domain_setup.cgi" || $current_page_full == "/virtual-server/edit_domain.cgi" || ($current_page_full == "/virtual-server/save_domain.cgi" && $(".panel-body").html() && $(".panel-body").html().indexOf("<scrip") === -1) || $current_page_full == "/virtual-server/summary_domain.cgi") {
        ...
        if ($__dom && ((window.parent.$("aside select").val() != $__dom && ($current_page_full != "/virtual-server/edit_domain.cgi" || $current_page_full != "/virtual-server/summary_domain.cgi")) || ($current_page_full == "/virtual-server/save_domain.cgi" || $current_page_full == "/virtual-server/rename.cgi" || $current_page_full == "/virtual-server/clone.cgi" || $current_page_full == "/virtual-server/move.cgi"))) {
            window.parent.loading_left_start();
            window.parent.$("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=virtualmin&dom=" + $__dom, function() {
                window.parent.loading_left_end();
                detect_current_left_menu("auto")
            })
        }
    }
    if ($current_page_full == "/virtual-server/search.cgi" && product_name(1).toLowerCase() != "virtualmin") {
        set_switch_position("open_virtualmin");
        window.parent.loading_left_start();
        window.parent.$("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=virtualmin", function() {
            window.parent.loading_left_end();
            detect_current_left_menu("auto")
        })
    }
    if (($current_page_full == "/server-manager/index.cgi" && $.url($__source_url).param("refresh") != "0") || ($current_page_full == "/server-manager/edit_serv.cgi" && $.url($__source_url).param("id") && window.parent.$("aside select").val() != $.url($__source_url).param("id")) || ($current_page_full == "/server-manager/save_serv.cgi" && $.url($__source_url).param("id") && !$.url($__source_url).param("reboot") && !$.url($__source_url).param("shutdown"))) {
        ...
        if ($.url($__source_url).param("id")) {
            ...
            window.parent.loading_left_start();
            window.parent.$("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=cloudmin&sid=" + $__id, function() {
                window.parent.loading_left_end();
                detect_current_left_menu("auto")
            })
        }
    }
    if ($current_page_full == "/server-manager/") {
        window.parent.detect_current_left_menu("server-manager/index.cgi")
    }
    if ($current_page_full == "/sysinfo.cgi" && $access_level == "0") {
        $("body").on("click", "a.csf, a[href]:not([href*='virtualmin'],[href*='cloud'],[href*='virtual-server'],[href*='server-manager'],[href*='http'],[href*='#'])", function(a) {
            if (product_name(1).toLowerCase() != "webmin") {
                set_switch_position("open_webmin");
                window.parent.loading_left_start();
                window.parent.$("body ul.navigation").load("index.cgi/?xhr-navigation=1&xhr-navigation-type=webmin", function() {
                    window.parent.loading_left_end()
                })
            }
        })
    ...
    function hidden_opener(b, a) {
        ...
        if ($("#" + b).hasClass("opener_shown")) {
            $("#" + b).parent(".opener_container").show().find("#" + b).slideUp(300, function() {
            ...
            $("#" + b).slideUp(0).removeClass("opener_hidden").addClass("opener_shown").parent(".opener_container").slideDown(300).find(".opener_shown").slideDown(300);
    ...
    if ($(".opener_shown").length > 0) {
        if ($(".opener_trigger").length > 0) {
            ...
            $(".opener_trigger").parents("table.table").attr("style", "margin-bottom:6px !important; border-collapse: separate !important; border: 0 !important; border-bottom:1px solid #ebebeb !important;");
            $(".opener_trigger").parents("tr").attr("style", "border: 0 !important");
            $(".opener_trigger").parent("td").attr("style", "vertical-align: middle; height:37px; text-align:left; border:0; border-left:1px solid #ebebeb; border-right:1px solid #ebebeb; border-top:4px solid #ebebeb; box-shadow:0 1px 1px rgba(0,0,0,.05); border-top-left-radius:4px; border-top-right-radius:4px");
            $(".opener_trigger").parent("td").find("a").addClass("link_hover_effect").attr("style", "padding-left:3px; font-size:16px; line-height: 20px !important; font-weight: 500 !important")
        }
    }
    if ($('a[href^="javascript:hidden_opener"]:not(".opener_trigger")').length > 0) {
        $('a[href^="javascript:hidden_opener"]:not(".opener_trigger")').each(function() {
            ...
            $(this).parents("table.table").attr("style", "margin-bottom:6px !important; border-collapse: separate !important; border: 0 !important; border-bottom:1px solid #ebebeb !important;");
            $(this).parent("td").attr("style", "vertical-align: middle; height:27px; background: #f7f7f7; text-align:left; border:0; border-left:1px solid #ebebeb; border-right:1px solid #ebebeb; border-top:4px solid #ebebeb; border-bottom:1px solid #ebebeb !important; border-top-left-radius:4px; border-top-right-radius:4px");
            $(this).parent("td").find("a").addClass("link_hover_effect").attr("style", "padding-left:6px; font-size:14px; font-weight: 500 !important; background: #f7f7f7 !important");
            if ($(this).parent().is(".panel-body") || $(this).parent().is(".ui_form")) {
                ...
                $(a).next("br").remove();
                $(a).attr("style", "vertical-align: middle; height:30px; background: #f7f7f7; text-align:left; border:0; border-left:1px solid #ebebeb; border-right:1px solid #ebebeb; border-top:4px solid #ebebeb; border-bottom:1px solid #ebebeb !important; border-top-left-radius:4px; border-top-right-radius:4px;");
                $(a).find("a").attr("style", "padding-left:8px; line-height:24px; font-size:14px; font-weight: 500 !important; background: #f7f7f7 !important").addClass("link_hover_effect");
    ...
    $(".authentic_update").on("click", function(a) {
        ...
        a.stopPropagation();
        __lrs();
        window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?updating");
    ...
    $('a[data-href*="/webmin/edit_webmincron.cgi"], a[data-href*="/package-updates/index.cgi"]').on("click contextmenu", function(a) {
        ...
        if ($(this).attr("data-refresh").indexOf("package-updates") !== -1) {
            window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?recollecting")
        } else {
            window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?recollect")
        }
    ...
    if (window.parent.location.search == "?updating-finished") {
        ...
        setTimeout(function() {
            ...
            $iframe.find(".panel-body #install").addClass("active");
            ...
            window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?updating-processing")
        }, 400)
    } else {
        if ($current_page_full && $current_page_full.indexOf("/webmin/install_theme.cgi") > -1 && window.parent.location.search == "?updating-processing") {
            window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?updating-finished");
            window.parent.$('iframe[name="page"]').attr("src", window.parent.$__source_host_complete + $webprefix + "/sysinfo.cgi")
        } else {
        ...
        window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?recollecting-package-updates");
        window.parent.$('iframe[name="page"]').attr("src", window.parent.$__source_host_complete + $webprefix + "/package-updates/index.cgi?mode=updates")
    } else {
        if ($current_page_full && $current_page_full.indexOf("/package-updates/index.cgi") > -1 && window.parent.location.search == "?recollecting-package-updates") {
            setTimeout(function() {
                ...
                a.submit();
                window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?recollecting-package-updates-processing")
            }, 400)
        } else {
            if ($current_page_full && $current_page_full.indexOf("/package-updates/update.cgi") > -1 && window.parent.location.search == "?recollecting-package-updates-processing") {
                ...
                window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?recollect");
                window.parent.$('iframe[name="page"]').attr("src", window.parent.$__source_host_complete + $webprefix + "/webmin/edit_webmincron.cgi")
            }
        }
        ...
        setTimeout(function() {
            ...
            $form_sysinfo.submit();
            window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?recollect-system-status")
        }, 400)
    } else {
        if ($current_page_full && $current_page_full.indexOf("/webmin/delete_webmincron.cgi") > -1 && window.parent.location.search == "?recollect-system-status") {
            window.parent.history.pushState(null, null, window.parent.$__source_host_complete + "/?recollect-finished");
            window.parent.$('iframe[name="page"]').attr("src", window.parent.$__source_host_complete + $webprefix + "/sysinfo.cgi")
        } else {
    ...
    if ($current_page == "status/") {
        $('td > label > img[src*="images/up.gif"]').each(function(b, a) {
            var c = $(this);
            $(a).attr("src", "" + $webprefix + "/images/check.png")
        });
        $('td > label > img[src*="images/down.gif"]').each(function(b, a) {
            var c = $(this);
            $(a).attr("src", "" + $webprefix + "/images/cross.png")
        });
        $('td > label > img[src*="images/not.gif"]').each(function(b, a) {
            var c = $(this);
            $(a).attr("src", "" + $webprefix + "/images/not.png")
        })
    }
    $('.ui_form[action^="delete_mons"] tr.ui_checked_columns > td > label > img[src="images/up.gif"], .ui_form[action^="save_mon"] img[src="images/up.gif"], table.ui_buttons_table > tbody > tr.ui_buttons_row > td.ui_buttons_label > img[src="images/up.gif"]').each(function(b, a) {
        var c = $(this);
        $(a).attr("src", "" + $webprefix + "/images/check.png")
    });
    $('.ui_form[action^="delete_mons"] tr.ui_checked_columns > td > label > img[src="images/down.gif"], .ui_form[action^="save_mon"] img[src="images/down.gif"], table.ui_buttons_table > tbody > tr.ui_buttons_row > td.ui_buttons_label > img[src="images/down.gif"]').each(function(b, a) {
        var c = $(this);
        $(a).attr("src", "" + $webprefix + "/images/cross.png")
    });
    $('.ui_form[action^="delete_mons"] tr.ui_checked_columns > td > label > img[src="images/not.gif"], .ui_form[action^="save_mon"] img[src="images/not.gif"], table.ui_buttons_table > tbody > tr.ui_buttons_row > td.ui_buttons_label > img[src="images/not.gif"]').each(function(b, a) {
        var c = $(this);
        $(a).attr("src", "" + $webprefix + "/images/not.png")
    });
    $('img[src^="images"]').each(function(b, a) {
        if ($current_page != "sysstats/" && $current_page != "translator/") {
            $(a).attr("src", "" + $webprefix + "/" + $(this).attr("src"))
        }
    });
    $('img[src^="../images"]').each(function(b, a) {
        $(a).attr("src", "" + $webprefix + "/" + $(this).attr("src").replace("../", ""))
    });
    ...
    $("textarea").each(function(e, h) {
        ...
        var b = ["edit_recs.cgi", "edit_dirs.cgi"];
        if (($(this).attr("name") == "data" || $(this).data("name") == "data" || $(this).attr("name") == "directives" || ($(this).attr("name") == "manual" && $current_page_full == "/fail2ban/edit_manual.cgi")) && $("textarea").length === 1 && $("textarea").parent("td.td_tag").length === 0 && $current_page != "init/" && b.indexOf($current_file) === -1) {
            if ($current_page_full != "/bind8/forward_form.cgi" && $current_page_full != "/bind8/slave_form.cgi" && $current_page_full != "/bind8/stub_form.cgi" && $current_page_full != "/bind8/mass_form.cgi") {
                $parent_width = g.parent("td").width() - 2;
                var f = CodeMirror.fromTextArea(h, {
                    mode: {
                ...
                f.setSize($parent_width, $window_height);
    ...
    if ($(".ui_table tr td").has(".ui_grid_table.table-hardcoded") && ($current_page == "passwd/" || $current_page == "mailboxes/" || $current_page_full == "/usermin/list_configs.cgi")) {
        $(".ui_table tr td .ui_grid_table.table-hardcoded").parents("table").css("border", "1px solid #ebebeb");
        $(".ui_table tr td .ui_grid_table.table-hardcoded").addClass("table").parents("tr").css("border", "1px solid #ebebeb")
    }
    ...
    function __tables() {
        if ($current_page == "backup-config/" && $("table#show_backup_destination") || $current_page_full == "/virtual-server/summary_domain.cgi" || $current_page_full == "/usermin/edit_categories.cgi" || $current_page_full == "/usermin/edit_defacl.cgi" || $current_page_full == "/proc/index_search.cgi" || $current_page_full == "/quota/list_groups.cgi" || $current_page_full == "/bind8/conf_misc.cgi" || $current_page_full == "/postfix/sasl.cgi" || $current_page_full == "/postfix/edit_master.cgi" || $current_page_full == "/squid/edit_icp.cgi" || $current_page_full == "/squid/edit_misc.cgi" || $current_page_full == "/cpan/edit_mod.cgi" || $current_page_full == "/phpini/edit_errors.cgi" || $current_page_full == "/acl/edit_acl.cgi" || $current_page_full == "/virtual-server/edit_domain.cgi" || $current_page_full == "/phpini/edit_misc.cgi") {
            return [$("table#show_backup_destination"), $('form[action="save_categories.cgi"] > .table-hardcoded'), $('form[action="save_defacl.cgi"] > .table-hardcoded'), $('form[action="index_search.cgi"] .sub_table_container.table-hardcoded'), $('form[action="save_misc.cgi"] .sub_table_container.table-hardcoded'), $('form[action="save_sasl.cgi"] .table-hardcoded'), $('form[action="save_master.cgi"] .sub_table_container.table-hardcoded'), $('form[action="save_icp.cgi"] .table.table-striped.table-rounded.table-condensed.table-subtable'), $('form[action="save_misc.cgi"] .table.table-striped.table-rounded.table-condensed.table-subtable'), $(".table-responsive > .table.table-striped.table-rounded.table-condensed.table-subtable"), $(".table-responsive > .table.table-striped.table-rounded.table-condensed.table-subtable > .sub_table_container.table-hardcoded"), $("#hiddendiv_opts")]
        } else {
            return false
        }
    }
    $.each(__tables(), function(b, c) {
        ...
        $.each(a.find("tbody"), function() {
            var f = $(this).children("tr"),
                d = [];
            $.each(f, function() {
                d.push($(this).children("td").length)
            });
            var e = Math.max.apply(this, d);
            $.each(f, function() {
                var g = $(this).children("td").length;
                if (e != g && !$(this).find("hr").length && __tables()) {
                    for (var h = 0; h < (e - g); h++) {
                        $(this).append("<td></td>")
                    }
                }
    ...
    $.each($("span > input"), function() {
        ...
        if (c) {
            c.attr("style", "display: inline; width: auto; height: 34px; margin-right:0 !important; margin-top:4px !important;")
        }
        if ($(this).parents(".tab-content")) {
            c.css("margin-top", "4px").css("margin-left", "3px")
        }
        if (a) {
            a.attr("style", "display: inline; width: auto; height: 34px; margin-right:0 !important; margin-top:4px !important;")
        }
        if (b) {
    ...
    if ($current_page == "cshrc/") {
        $("textarea").each(function(a, b) {
            $(this).attr("style", "height: 20em !important")
        })
    }
    if ($current_page_full == "/acl/" || $current_page_full == "/acl/edit_user.cgi") {
    ...
    if ($current_page == "custom/") {
        ...
        $.each($('td.td_tag:contains("|")'), function() {
            $(this).find('a[href^="edit_"]').addClass("ui_link_replaced btn btn-danger btn-xxs").css("margin-right", "3px").removeClass("ui_link").prepend('<i class="fa fa-pencil">&nbsp;</i>');
    ...
    if ($current_page_full == "/virtual-server/edit_link.cgi") {
    ...
    if ($current_page_full.indexOf(".cgi") === -1 && $current_page == "useradmin/") {
    ...
    if ($current_page == "proc/" || $current_page == "/proc/index.cgi" || ($current_page == "fetchmail/" && $("link").attr("href") == "/images/favicon-usermin.ico")) {
        if ($current_page == "proc/" || $current_page == "/proc/index.cgi") {
    ...
    if ($current_page == "dhcpd/") {
        $(".panel-body > p").contents().filter(function() {
            return this.nodeType == 3
        }).remove()
    }
    if ($current_page == "htaccess-htpasswd/" || $current_page == "forward/") {
    ...
    $("textarea.form-control.ui_textarea").next('button[type="button"].btn-default').each(function() {
        ...
        $(this).attr("style", "width:100% !important; padding-top: 0; height:30px !important")
    });
    ...
    if (settings_right_iconize_header_links) {
        $.each($(".panel-heading > table.header > tbody > tr > td > a"), function() {
            if ($(this).attr("href") && $(this).attr("href").indexOf("config.cgi") > -1 || $(this).attr("href").indexOf("man/search.cgi") > -1 || $(this).attr("href").indexOf("/index.cgi") > -1 || ($(this).attr("href").indexOf("index.cgi") > -1 && $current_page == "openvpn/") || $(this).attr("href").indexOf("restart.cgi") > -1 || $(this).attr("href").indexOf("apply.cgi") > -1 || $(this).attr("href").indexOf("start.cgi") > -1 || $(this).attr("href").indexOf("stop.cgi") > -1 || $(this).attr("href").indexOf("delete_") > -1 || $(this).attr("href").indexOf("list_mail.cgi") > -1 || $(this).attr("href").indexOf("/virtual-") > -1 || $(this).attr("href").indexOf("/virtualmin-") > -1 || $(this).attr("href").indexOf("/server-") > -1 || $(this).attr("href").indexOf("help.cgi") > -1) {
                ...
                if ($(this).attr("href").indexOf("/index.cgi") > -1 || $(this).attr("href").indexOf("/virtual-") > -1 || $(this).attr("href").indexOf("/virtualmin-") > -1 || $(this).attr("href").indexOf("/server-") > -1) {
                                    ...
                                    if ($(this).attr("href").indexOf("man/search.cgi") > -1) {
                                        ...
                                        if ($(this).attr("href").indexOf("delete_") > -1) {
                                            ...
                                            if ($(this).attr("href").indexOf("list_mail.cgi") > -1) {
                                                ...
                                                if ($(this).attr("href").indexOf("index.cgi") > -1 && $current_page == "openvpn/") {
    ...
    $(".help_popup").on("click", function(a) {
        ...
        b.find("._tmp_help_content").load(c.attr("href"), function() {
            ...
            $help_body = b.find("._tmp_help_content h3").remove();
            ...
            c.popover("show");
            $('body:not(".help_popup")').on("click", function() {
                c.popover("destroy")
            });
    ...
    if ($current_page == "fdisk/" || $current_page == "postfix/" || $current_page == "pam/" || $current_page == "syslog/") {
        $("p > a[href], table + a[href], div.panel-body > a.ui_link").each(function(a, b) {
            $(this).text($(this).text().replace(/\.$/, ""))
        })
    }
    $('body[data-current-product="usermin"] div.panel-body > p > a, body[data-current-product="usermin"] div.panel-body > a[href^="edit_"], .ui_form > a, .ui_grid_cell > :not(input) + a.ui_link, .ui_grid_cell > a.select_all, .ui_grid_cell > a.select_invert, .ui_grid_cell > :not(input) + a[href*=".cgi"], .ui_grid_cell > a[href*=".cgi"]:first-child, .tab-pane > p > a, .tab-pane > a.ui_link, .tab-pane > .table-condensed > a.ui_link, .panel-body > p > a.ui_link, a.select_all, a.select_invert').each(function() {
        if ($current_page != "passwd/" && $(this).text() && $current_page_full != "/mailboxes/" && $current_page_full != "/mailboxes/index.cgi" && $current_page_full != "/usermin/list_configs.cgi" && !$(this).hasClass("help_popup")) {
            $(this).addClass("btn btn-inverse btn-tiny ui_link_replaced");
            $(this).text($(this).text().replace(/\.$/, ""));
            if ($('.ui_form:contains("|")').length || $current_page == "custom/") {
                $(this).parent().contents().filter(function() {
                    return this.nodeType == 3
                }).remove()
            }
            ...
            if (($(this).attr("href").indexOf("edit") === 0 && $(this).attr("href").indexOf("edit_allow") !== 0) || $(this).attr("href").indexOf("master_form") === 0 || $(this).attr("href").indexOf("slave_form") === 0 || $(this).attr("href").indexOf("stub_form") === 0 || $(this).attr("href").indexOf("forward_form") === 0 || $(this).attr("href").indexOf("delegation_form") === 0 || $(this).attr("href").indexOf("mass_form") === 0 || $(this).attr("href").indexOf("newdb_form") === 0) {
                ...
                if ($(this).attr("href").indexOf("edit_allow") === 0) {
                    $(this).html('<i class="fa fa-shield"> </i> ' + $(this).text())
                } else {
                    if ($(this).attr("href").indexOf("mass_ucreate") === 0) {
    ...
    $("a.ui_link_replaced").each(function() {
        if ($(this).next().is("a.ui_link_replaced") && !$(this).hasClass("select_all") && !$(this).hasClass("select_invert")) {
            $(this).next("a.ui_link_replaced").attr("style", "margin-left: 3px !important;");
            return false
        } else {
            if ($(this).prev().is("a.ui_link_replaced") && !$(this).hasClass("select_all") && !$(this).hasClass("select_invert")) {
                $(this).prev("a.ui_link_replaced").attr("style", "margin-right: 3px !important;");
                return false
            }
        }
    });
    if ($current_page == "fetchmail/") {
    ...
    $.each($(".panel-body > .ui_link"), function() {
        if ($current_page == "pam/" || $current_page == "syslog/" || $current_page_full == "/postfix/master.cgi") {
    ...
    if ($current_page == "mailboxes/" || $current_page == "/mailboxes/index.cgi" || $current_page == "mailbox/" || $current_page_full == "/postfix/view_mailq.cgi") {
        ...
        $("body").find('input[name="from"]').parents(".tab-pane ").parent("td").find("div, table").each(function(a, b) {
            ...
            $(this).find('input[name="subject"]').parent("td").prev("td").find("b").attr("style", "font-size: 14px !important");
        ...
        $editor_mode_link_button.attr("title", $editor_mode_link_button.text()).addClass("editor_mode_link_button pull-right btn " + ($editor_mode_link_button_state == -1 ? "btn-success" : "btn-primary")).html('<i class="fa fa-lg ' + ($editor_mode_link_button_state == -1 ? "fa-font" : "fa-align-justify") + '"> </i>');
        ...
        if ($current_page_full.indexOf("view_mail.cgi") > -1) {
            ...
            $(".table-title > a.table_title_links").each(function() {
                $table_title_header_container_text_padding = ($current_page_full == "/postfix/view_mailq.cgi" ? 120 : 235)
            });
            ...
            $("a.table_title_links").on("click", function() {
                if ($(this).attr("href").indexOf("&raw=1") === -1) {
                    __lrs()
                }
            })
        }
    ...
    if ($current_page_full == "/virtual-server/domain_form.cgi") {
    ...
    if (settings_sysinfo_easypie_charts && $current_page_full == "/sysinfo.cgi") {
    ...
    setTimeout(function() {
        if ($current_page_full == "/acl/edit_user.cgi") {
            $("table.table-hardcoded td.col_value table.ui_grid_table.table-hardcoded").each(function() {
                $(this).find("tbody").attr("style", "border-top:1px solid #ebebeb !important; " + $(this).attr("style"))
            })
        }
    }, 300);
    ...
    if (($current_page_full.indexOf(".cgi") === -1 || $current_page_full == "/postfix/mailq.cgi" || $current_page_full == "/webmin_search.cgi" || $current_page_full == "/useradmin/index.cgi" || $current_page_full == "/quota/list_users.cgi" || $current_page_full == "/quota/list_groups.cgi" || $current_page_full == "/init/index.cgi") && ($current_page == "webmin_search.cgi/" || $current_page == "postfix/" || $current_page == "virtual-server/" || $current_page == "init/" || $current_page == "mount/" || $current_page == "custom/" || $current_page == "quota/" || $current_page == "fsdump/" || $current_page == "inittab/" || $current_page == "logrotate/" || $current_page == "mailcap/" || $current_page == "cron/" || $current_page == "software/" || $current_page == "syslog/" || $current_page == "useradmin/" || $current_page == "apache/" || $current_page == "webalizer/" || $current_page == "cpan/" || $current_page == "htaccess-htpasswd/" || $current_page == "fdisk/") || $current_page_full == "/man/search.cgi" || $current_page_full == "/proc/index_tree.cgi" || $current_page_full == "/proc/index_user.cgi" || $current_page_full == "/proc/index_size.cgi" || $current_page_full == "/proc/index_cpu.cgi" || $current_page_full == "/proc/index_search.cgi" || $current_page_full == "/software/search.cgi" || $current_page_full == "/virtual-server/index.cgi" || $current_page_full == "/virtual-server/list_users.cgi" || $current_page_full == "/virtual-server/edit_newplan.cgi" || $current_page_full == "/virtual-server/edit_newfeatures.cgi" || $current_page_full == "/virtual-server/edit_newtmpl.cgi" || $current_page_full == "/virtual-server/backuplog.cgi" || $current_page_full == "/package-updates/index.cgi" || $current_page_full == "/virtual-server/usage.cgi" || $current_page_full == "/virtual-server/search.cgi" || (($current_page_full == "/fetchmail/" || $current_page_full == "/filter/") && product_name() == "Usermin")) {
        $("table").each(function() {
            if ($(this).find("thead").length && $(this).find("thead tr th").length > 2) {
                if ($(this).find("thead").length > 1) {
                    var a = $(this).find("thead:first-child");
                    a.remove();
                    if (product_name() == "Dash" && ($current_page_full == "/quota/list_users.cgi" || $current_page_full == "/quota/list_groups.cgi")) {
                        $(this).before(a);
...
$(window.parent.$("#iframe")).on("load", function() {
    if (window.parent.$('iframe[name="page"]').contents().find("title").text() == "ConfigServer Security & Firewall" && window.parent.$('iframe[name="page"]').contents().find("body.csf").length === 0) {
        $("#iframe").contents().find("body").on("click", 'input[type="submit"], a[href^="index.cgi?action=temp"]', function() {
            window.parent.__lrs()
        });
        ...
        $csf.find("head").append('				<link rel="shortcut icon" href="' + $webprefix + '/images/favicon-webmin.ico">				<meta name="viewport" content="width=device-width, initial-scale=1.0">				<link href="' + $webprefix + '/unauthenticated/css/bootstrap.min.css?v1200" rel="stylesheet" type="text/css">				<link href="' + $webprefix + '/unauthenticated/css/fontawesome.min.css?v1200" rel="stylesheet" type="text/css">				<link href="' + $webprefix + '/unauthenticated/css/codemirror.min.css?v1200" rel="stylesheet" type="text/css">				<link href="' + $webprefix + '/unauthenticated/css/jquery.datatables.min.css?v1200" rel="stylesheet" type="text/css">				<link href="' + $webprefix + '/unauthenticated/css/default.min.css?v1200" rel="stylesheet" type="text/css">			');
        $.each(window.parent.$('link[href*="/styles.css"]'), function() {
            if ($(this)) {
                $csf.find("head").append('<link href="' + $webprefix + '/unauthenticated/css/styles.css" rel="stylesheet" type="text/css">')
            }
        });
        ...
        $csf.find(".panel-default").css("border-color", "#e6e6e6").css("border-top-width", "4px").prepend('<div class="panel-heading" style="text-align:center"><font size="+2">ConfigServer Security & Firewall</font></div>');
        $csf.find(".panel-body > img:first-child, .panel-body > b").remove();
        $csf.find("#CSFajax").css("border", "1px solid #ebebeb");
        ...
        if ($csf.find(".csf h2").text().indexOf("Ports listening for external connections and the executables running behind them") !== -1) {
            $csf.find("table").each(function() {
                if (!$(this).find("thead").length) {
                    ...
                    c.attr("style", "width: 100% !important");
                    c.attr("style", "min-width: 100% !important");
                    c.prepend("<thead>" + d.html() + "</thead>");
        ...
        if ($csf.find(".csf .table.table-striped.table-condensed tbody th:eq(1)").text().indexOf("A/D") !== -1 && $csf.find(".csf .table.table-striped.table-condensed tbody th:eq(2)").text().indexOf("IP address") !== -1) {
            $csf.find("table").each(function() {
                if (!$(this).find("thead").length) {
                    ...
                    c.find('img[src^="csfimages/"]').each(function() {
        ...
        $csf.find('table > tbody > tr:first-child > th:first-child, table[align="center"] > tbody > tr:first-child').each(function() {
            $(this).css("border-top", "4px solid #ebebeb")
        });
        $csf.find('table[align="center"] > tbody > tr > td.section-title').each(function() {
            $(this).parent("tr").css("border-top", "4px solid #ebebeb")
        });
            ...
            if ($(this).text().indexOf("2006-20") >= 0) {
                if ($hostname == settings_allowed_hostname) {
                    ...
                    $csf.find(".csf td").each(function() {
                        if ($(this).text().indexOf("While we are happy to provide these scripts for free") >= 0) {
                            $(this).parents("table").remove()
                        }
                    })
                } else {
        ...
        $csf.find(".csf .paginationstyle > select").each(function() {
        ...
        $csf.find(".csf #paginatediv > select").each(function() {
            $(this).attr("style", "vertical-align: top !important; margin-top: 0 !important")
        });
        $csf.find('img[src="csfimages/loader.gif"]').each(function() {
            $(this).attr("src", "" + $webprefix + "/images/loader-horizontal.gif").css("margin-left", "10px")
        });
        ...
        setTimeout(function() {
            $csf.find('textarea[name="formdata"]').each(function(c, f) {
                var e = $(this);
                $parent_width = e.parent("td").width();
                var d = CodeMirror.fromTextArea(f, {
                    mode: {
                        name: "rpm-spec"
                    },
                    tabMode: "indent",
                ...
                d.setSize($parent_width, $window_height);
                $(window).resize(function() {
                    $parent_width = e.parent("td").width();
                    $window_height = ($(window).outerHeight() - ($(window).outerHeight() / 2));
                    d.setSize($parent_width, $window_height)
        ...
        $("#iframe").contents().find("body").on("keydown", function(c) {
            window.parent.search_control(c);
            window.parent.shortcut_control(c)
        });
        setTimeout(function() {
            window.parent.clear_menu_select();
            window.parent.__lre();
            window.parent.detect_current_left_menu("csf/")
        }, 200)
    }
});